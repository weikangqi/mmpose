...
train_pipeline_stage1 = [
    dict(type='Load2Image', backend_args=None),
    # dict(
    #     type='Mosaic',
    #     img_scale=(640, 640),
    #     pad_val=114.0,
    ...
    dict(type='PackPose2Inputs'),
]
train_pipeline_stage2 = [
    dict(type='Load2Image'),
    dict(
        type='BottomupRandomAffine',
        input_size=(640, 640),
        shift_prob=0,
...
dataset_coco = dict(
    ...
    data_root=data_root,
    data_mode=data_mode,
    ann_file='cocod/annotations/train.json',
    data_prefix=dict(img='cocod/train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='cocod/annotations/val.json',
        data_prefix=dict(img='cocod/val/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'cocod/annotations/val.json',
    score_mode='bbox',
    nms_mode='none',
)
...
model = dict(
    ...
    data_preprocessor=dict(
        type='PoseData2Preprocessor',
        pad_size_divisor=32,
        mean=[0, 0, 0],
        std=[1, 1, 1],
        batch_augments=[
            dict(
                type='Batch2SyncRandomResize',
