...
class BaseStereoCocoStyleDataset(BaseDataset):
    ...
    def _load_annotations(self) -> Tuple[List[dict], List[dict]]:
        ...
        for img_id in self.coco.getImgIds():
            ...
            img.update({
                ...
                'right_img_path':osp.join(self.data_prefix['img'], img['right_file_name']),
    ...
    def parse_data_info(self, raw_data_info: dict) -> Optional[dict]:
        ...
        data_info = {
            ...
            'right_img_path':img['right_img_path'],
            'bbox': bbox,
    ...
    def _get_bottomup_data_infos(self, instance_list: List[Dict],
        ...
        for img_id, data_infos in groupby(instance_list,
            ...
            right_img_path = data_infos[0]['right_img_path']
            data_info_bu = {
                'img_id': img_id,
                'img_path': img_path,
            ...
            for img_info in image_list:
                if img_info['img_id'] not in used_img_ids:
                    data_info_bu = {
                        ...
                        'right_img_path':img_info['right_img_path'],
                        'id': list(),
                        'raw_ann_info': None,
                    }
                    data_list_bu.append(data_info_bu)
