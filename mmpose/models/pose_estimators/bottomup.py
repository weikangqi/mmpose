...
from .base import BasePoseEstimator,StereoBasePoseEstimator
...
@MODELS.register_module()
class StereoBottomupPoseEstimator(StereoBasePoseEstimator):
    """Base class for bottom-up pose estimators.
    ...
    def loss(self, inputs: Tensor, data_samples: SampleList) -> dict:
        ...
        Returns:
            dict: A dictionary of losses.
        """
        feats = self.extract_feat(inputs['left'],inputs['right'])
