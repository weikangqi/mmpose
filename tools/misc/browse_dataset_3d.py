...
def main():
    ...
    for idx in indexes:
        ...
        if args.mode == 'original':
            ...
            gt3d_instances = InstanceData()
            gt2d_instances = InstanceData()
            gt3d_instances.keypoints = item['keypoints_3d']
            
            gt2d_instances.keypoints = item['keypoints']
            
            if item['keypoints_visible'].ndim == 3:
                gt3d_instances.keypoints_visible = item['keypoints_visible'][...,
                                                                           0]
            else:
                gt3d_instances.keypoints_visible = item['keypoints_visible']
            gt2d_instances.bboxes = item['bbox']
            gt2d_instances.keypoints_visible = gt3d_instances.keypoints_visible
            gt3d_instances.keypoint_scores = gt3d_instances.keypoints_visible
            data3d_sample = PoseDataSample()
            data3d_sample.pred_instances = gt3d_instances
