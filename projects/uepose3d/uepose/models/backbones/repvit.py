...
class RepViT(BaseBackbone):
    def __init__(self, cfgs, feat_out_indice=[], num_classes=1000, distillation=False ,init_cfg: Union[dict, List[dict], None] = None):
        ...
        self.feat_out_indice = feat_out_indice
    ...
    def forward(self, x):
        ...
        for idx,f in enumerate( self.features):
            x = f(x)
            if idx in self.feat_out_indice:
                outs.append(x)
